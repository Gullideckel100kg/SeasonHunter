...
public class FragWorkTimeCalender extends Fragment
{
    ...
    private void SetStartDateView()
    {
        isStartDate = true;
        isEndDate = false;
        linStartDate.setBackground(getContext().getResources().getDrawable(R.drawable.costum_border_calender));
    ...
    private void SetEndDateView()
    {
        isStartDate = false;
        isEndDate = true;
        linEndDate.setBackground(getContext().getResources().getDrawable(R.drawable.costum_border_calender));
